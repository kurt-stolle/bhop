...
if (SERVER) then
	resource.AddFile("materials/deathrunexcl/crosshair.png");
...
SWEP.AimPos = Vector (-6.0, -5.4248, 2.85)
...
if CLIENT then
	...
	function SWEP:DrawHUD()
		...
		surface.DrawTexturedRectRotated(x - gap - 14/2,y,16,16,270+180);
		surface.DrawTexturedRectRotated(x + gap + 14/2,y,16,16,90+180);
		surface.DrawTexturedRectRotated(x, y + gap + 14/2,16,16,0+180);
		surface.DrawTexturedRectRotated(x, y - gap - 14/2,16,16,180+180);
	end
end
